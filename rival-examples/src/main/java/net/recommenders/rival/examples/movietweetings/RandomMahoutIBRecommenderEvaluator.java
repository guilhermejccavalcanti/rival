...
public final class RandomMahoutIBRecommenderEvaluator {
  ...
  @SuppressWarnings(value = { "unchecked" }) public static void prepareStrategy(final String splitPath, final String recPath, final String outPath) {
    ...
    try {
      strategy = (EvaluationStrategy<Long, Long>) (Class.forName(strategyClassName)).getConstructor(DataModelIF.class, DataModelIF.class, double.class).newInstance(trainingModel, testModel, threshold);
